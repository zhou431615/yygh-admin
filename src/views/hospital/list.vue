...
<!--          @change="cityChanged"-->
    ...
    <el-table v-loading="listLoading" :data="list"
      ...
      <el-table-column label="操作" width="230" align="center">
        <template slot-scope="scope">
          <el-button v-if="scope.row.status === 1" type="primary" size="mini" @click="updateStatus(scope.row.id, 0)">上线
          </el-button>
          <el-button v-if="scope.row.status === 0" type="danger" size="mini" @click="updateStatus(scope.row.id, 1)">下线
          </el-button>
